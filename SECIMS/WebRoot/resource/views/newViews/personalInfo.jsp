						...
						<div class="card-content">
							<form class="form-horizontal info-group" id="userInfoForm">
								<div class="form-group">
									<label class="col-sm-2 control-label" style="line-height: 100px;">头像</label>
									<div class="col-sm-10">
										<div class="avatar-wrap">
											<div class="avatar-img">
												<span>赵<shiro:principal></shiro:principal></span>
											</div>
											<div class="avatar-set">
												<a class="btn btn-ghost btn-primary">更换头像</a>
											</div>
										</div>
									</div>
								</div>
